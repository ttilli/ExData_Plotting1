...
#plot.new()
#--------- plot1 
plot(hpc$DateTime,hpc$Global_active_power,type="l",main="",xlab="",ylab="Global Active Power")

#------- plot 2
plot(hpc$DateTime,hpc$Voltage,type="l",main="",xlab="",ylab="Voltage")

#----- plot 3
plot(hpc$DateTime,hpc$Sub_metering_1,type="l",col="black",main="",xlab="",ylim=c(0,40),ylab="Energy sub metering")

par(new=TRUE)
plot(hpc$DateTime,hpc$Sub_metering_2,type="l",col="red",main="",xlab="",ylim=c(0,40),ylab="Energy sub metering")

par(new=TRUE)
plot(hpc$DateTime,hpc$Sub_metering_3,type="l",col="blue",main="",xlab="",ylim=c(0,40),ylab="Energy sub metering")
legend("topright",lty=1,bty="n",col=c("black","red","blue"),legend=c("Sub metering 1","Sub metering 2","Sub metering 3"))

par(new=FALSE)
#----------plot 4

plot(hpc$DateTime,hpc$Global_reactive_power,type="l",main="",xlab="",ylab="Global_reactive_power")
